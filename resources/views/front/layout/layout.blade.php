...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('@yield('header_img')">
    <div class="overlay"></div>
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1 style="font-size:45px !important">@yield('header_name')</h1>
            <span class="subheading">@yield('header_subname')</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <p class="copyright text-muted">Copyright &copy; My blog Website 2021 | <a href="{{url('admin/login')}}">Admin Login</a></p>
        </div>
      </div>
    </div>
  </footer>
  ...
  <script src="{{asset('front_asset/js/jqBootstrapValidation.js ')}}"></script>
  <script src="{{asset('front_asset/js/contact_me.js')}}"></script>
